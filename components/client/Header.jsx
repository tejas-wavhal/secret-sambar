...
const Header = () => {
  ...
  return (
    <>
      <header className="w-full z-30 text-mainGreen border-b-2 border-gray-300 shadow-lg flex items-center justify-between px-4 lg:px-10 py-0.5 font-montserrat bg-mainOrange/40">
